...
def extract_month_from_text(text):
    ...
    # 從文字中提取月份名稱，例如 "Last updated: September 2024"
...
# 包含Excel檔案的目錄
input_dir = r'D:\Users\paulli1\Desktop\Project Flexis\Market Data\2024'
output_file = 'processed_LGV_data_2024_all_months.xlsx'
...
for filename in expected_files:
    ...
    try:
        ...
        filtered_df.loc[:, 'Registration Year'] = 2024
    ...
    if 'may' in filename.lower():
        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                print("May 2024檔案中的列名：", may_df.columns.tolist())
                print("May 2024檔案的前幾行：")
                print(may_df.head())
            except Exception as e:
