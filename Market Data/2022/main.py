...
def extract_month_from_text(text):
    ...
    # 從文字中提取月份名稱，例如 "Last updated: September 2022"
...
# 包含Excel檔案的目錄
input_dir = r'D:\Users\paulli1\Desktop\Project Flexis\Market Data\2022'
output_file = 'processed_LGV_data_2022_all_months.xlsx'

# 2022年的檔案名稱
expected_files = [
    'particulars of first registered vehicle_jan2022.xlsx',
    'particulars of first registered vehicle_feb2022.xlsx',
    'particulars of first registered vehicle_mar2022.xlsx',
    'particulars of first registered vehicle_apr2022.xlsx',
    'particulars of first registered vehicle_may2022.xlsx',
    'particulars of first registered vehicle_jun2022.xlsx',
    'particulars of first registered vehicle_Jul 2022.xlsx',
    'particulars of first registered vehicle_aug2022.xlsx',
    'particulars of first registered vehicle_sep2022.xlsx',
    'particulars of first registered vehicle_oct2022.xlsx',
    'particulars of first registered vehicle_nov2022.xlsx',
    'particulars of first registered vehicle_dec2022.xlsx'
]
...
for filename in expected_files:
    ...
    try:
        ...
        filtered_df.loc[:, 'Registration Year'] = 2022
    ...
    if 'may' in filename.lower():
        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                print("May 2022檔案中的列名：", may_df.columns.tolist())
                print("May 2022檔案的前幾行：")
                print(may_df.head())
            except Exception as e:
