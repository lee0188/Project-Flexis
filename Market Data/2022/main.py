...
# 包含Excel檔案的目錄
input_dir = r'D:\Users\paulli1\Desktop\MINI BUS Research\Market Data\2022'
output_file = 'processed_light_bus_data_2022_all_months.xlsx'

# 2022年的檔案名稱，根據圖片中的檔案名稱
expected_files = [
    ...
    'particulars of first registered vehicle_Jul 2022.xlsx',  # 注意這裡有空格
...
for filename in expected_files:
    ...
    try:
        ...
        filtered_df['Registration Year'] = 2022
