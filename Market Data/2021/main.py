...
def extract_month_from_text(text):
    ...
    # 從文字中提取月份名稱，例如 "Last updated: September 2021"
...
# 包含Excel檔案的目錄
input_dir = r'D:\Users\paulli1\Desktop\Project Flexis\Market Data\2021'
output_file = 'processed_LGV_data_2021_all_months.xlsx'

# 2021年的檔案名稱
expected_files = [
    'particulars of first registered vehicle_jan2021.xlsx',
    'particulars of first registered vehicle_feb2021.xlsx',
    'particulars of first registered vehicle_mar2021.xlsx',
    'particulars of first registered vehicle_apr2021.xlsx',
    'particulars of first registered vehicle_may2021.xlsx',
    'particulars of first registered vehicle_jun2021.xlsx',
    'particulars of first registered vehicle_jul2021.xlsx',
    'particulars of first registered vehicle_aug2021.xlsx',
    'particulars of first registered vehicle_sep2021.xlsx',
    'particulars of first registered vehicle_oct2021.xlsx',
    'particulars of first registered vehicle_nov2021.xlsx',
    'particulars of first registered vehicle_dec2021.xlsx'
]
...
for filename in expected_files:
    ...
    try:
        ...
        filtered_df.loc[:, 'Registration Year'] = 2021
    ...
    if 'may' in filename.lower():
        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                print("May 2021檔案中的列名：", may_df.columns.tolist())
                print("May 2021檔案的前幾行：")
                print(may_df.head())
            except Exception as e:
