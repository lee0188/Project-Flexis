...
def extract_month_from_text(text):
    ...
    # 從文字中提取月份名稱，例如 "Last updated: September 2023"
...
# 包含Excel檔案的目錄
input_dir = r'D:\Users\paulli1\Desktop\Project Flexis\Market Data\2023'
output_file = 'processed_LGV_data_2023_all_months.xlsx'
...
expected_files = [
    ...
    'particulars of first registered vehicle_Sep 2023.xlsx',
    'particulars of first registered vehicle_Oct 2023.xlsx',
    'particulars of first registered vehicle_Nov 2023.xlsx',
    'particulars of first registered vehicle_Dec 2023.xlsx'
]
...
for filename in expected_files:
    ...
    try:
        ...
        filtered_df.loc[:, 'Registration Year'] = 2023
    ...
    if 'may' in filename.lower():
        ...
        if os.path.exists(file_path):
            ...
            try:
                ...
                print("May 2023檔案中的列名：", may_df.columns.tolist())
                print("May 2023檔案的前幾行：")
                print(may_df.head())
            except Exception as e:
